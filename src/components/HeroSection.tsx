...
const HeroSection: React.FC = () => {
  return (
    <section id="hero" className="relative h-screen flex items-center justify-center text-white overflow-hidden">
      ...
      {/*</video>*/}
      <div className="hero-video-overlay z-10"></div>
      ...
      <div className="relative z-20 container mx-auto px-4 sm:px-6 lg:px-8 text-center animate-fade-in-up">
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-display font-bold mb-6 animate-text-focus-in">
          <span className="block text-white leading-tight">Dynamic Solutions</span>
          <span className="block text-orange-vibrant leading-tight">For Modern Construction</span>
        </h1>
        <p className="text-sm md:text-xl lg:text-2xl text-gray-200 mb-10 max-w-3xl mx-auto animate-fade-in-up animation-delay-300">
        ...
        <div className="flex flex-wrap justify-center gap-4 animate-fade-in-up animation-delay-600">
          ...
          <Button href="#contact" asLink variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-charcoal-deep dark:border-white dark:text-white dark:hover:bg-white dark:hover:text-charcoal-deep">
            Get a Quote
          </Button>
        </div>
      </div>
